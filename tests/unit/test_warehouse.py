...
# def test_put_warehouse_inventory_no_auth(client, payload, expected_status):
    # response = client.delete(endpoint)
    # assert response.status_code == expected_status
# def test_delete_warehouse_inventory_auth(client, payload, headers, expected_status):
    # response = client.delete(endpoint, headers=headers)
    # assert response.status_code == expected_status
# def test_delete_warehouse_inventory_no_auth(client, payload, expected_status):
    # response = client.delete(endpoint)
    # assert response.status_code == expected_status